...
This document indexes all plan sections for the Multi-Agent System for Software Development via Jira.

## Plan Sections

| # | Section | Status |
|---|---------|--------|
| 01 | [Overview](./plans/01-overview.md) | — |
| 02 | [Tech Stack (MVP)](./plans/02-tech-stack.md) | ✅ Completed |
| 03 | [Data Model (MVP)](./plans/03-data-model.md) | ✅ Completed |
| 04 | [Jira Integration (MVP)](./plans/04-jira-integration.md) | ✅ Completed |
...
| 14 | [Reference Resources](./plans/14-reference-resources.md) | — |

## Quick Navigation

- **[Overview](./plans/01-overview.md)** — System architecture, main flow, and principles
- **[Tech Stack](./plans/02-tech-stack.md)** — Frontend, backend, LLM, database, Docker setup
- **[Data Model](./plans/03-data-model.md)** — PostgreSQL schema and SQLAlchemy models
- **[Jira Integration](./plans/04-jira-integration.md)** — Polling, API, ticket lifecycle
- **[Agents](./plans/05-agents.md)** — Architect, Backend, Frontend, QA agents with Strands SDK
...
- **[References](./plans/14-reference-resources.md)** — External links and documentation
